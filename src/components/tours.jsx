//TIME SPENT: calculating time spent is not working properly
...
const TourOperations = () => {
  ...
  const fetchTours = async () => {
    try {
      const response = await fetch('http://localhost:3001/admin/tours' , { headers:{Authorization: `Bearer ${token}`},
});
                ...
                <Card key={stopIndex} style={{ marginBottom: '10px' }}>
                  <CardContent>
                    ...
                    <TextField
                      ...
                      fullWidth
                      variant="outlined"
                      value={stop.notes || ''} // Provide default value
                    ...
                    <TextField
                      ...
                      fullWidth
                      variant="outlined"
                      value={stop.image || ''} // Provide default value
                    ...
                    <TextField
                      ...
                      fullWidth
                      variant="outlined"
                      value={stop.duration || ''} // Provide default value
                    ...
                    <TextField
                      ...
                      fullWidth
                      variant="outlined"
                      value={stop.pros ? stop.pros.join(', ') : ''} // Provide default value
